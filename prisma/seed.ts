...
const ECOM_WAREHOUSE_CATEGORY = 'Ecomm Supply Order'
const ECOM_BOOKS_CATEGORY = 'Ebooks Supply Order'
const EBOOKS_MAINTENANCE_CATEGORY = 'Ebooks Maintenance Order'
const ECOMM_MAINTENANCE_CATEGORY = 'Ecomm Maintenance Order'
...
async function main() {
  ...
  const products = await prisma.product.createMany({
    data: [
      // General Supplies
      { name: 'Copy Paper', category: 'Store Supply Order', unitPriceCents: 500, maxQuantity: 3, isActive: true },
      { name: 'Clear Barbs', category: 'Store Supply Order', unitPriceCents: 300, maxQuantity: 10, isActive: true },
      { name: 'Super Slices', category: 'Store Supply Order', unitPriceCents: 400, maxQuantity: 3, isActive: true },
      { name: 'Garment Guns', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 2, isActive: true },
      { name: 'Garment Needles', category: 'Store Supply Order', unitPriceCents: 250, maxQuantity: 5, isActive: true },
      { name: 'Furniture Tags (book)', category: 'Store Supply Order', unitPriceCents: 600, maxQuantity: 6, isActive: true },
      { name: 'Sizing Rings (S–XL)', category: 'Store Supply Order', unitPriceCents: 350, maxQuantity: 10, isActive: true },
      { name: 'Sizing Ring Squares (S–XL)', category: 'Store Supply Order', unitPriceCents: 350, maxQuantity: 10, isActive: true },
      { name: "Men's Sizing Rings", category: 'Store Supply Order', unitPriceCents: 300, maxQuantity: 2, isActive: true },
      { name: "Women's Sizing Rings", category: 'Store Supply Order', unitPriceCents: 300, maxQuantity: 2, isActive: true },
      { name: "Women's Sizing Ring Squares", category: 'Store Supply Order', unitPriceCents: 300, maxQuantity: 2, isActive: true },
      { name: "Children's Sizing Rings", category: 'Store Supply Order', unitPriceCents: 300, maxQuantity: 4, isActive: true },
      { name: 'Large Rubberbands', category: 'Store Supply Order', unitPriceCents: 500, maxQuantity: 5, isActive: true },
      { name: 'ECOMM Dymo Labels', category: 'Store Supply Order', unitPriceCents: 450, maxQuantity: 1, isActive: true },
      { name: 'ECOMM Jewelry Bags (bundle)', category: 'Store Supply Order', unitPriceCents: 300, maxQuantity: 3, isActive: true },
      { name: 'ECOMM Seals (bag of 100)', category: 'Store Supply Order', unitPriceCents: 400, maxQuantity: 2, isActive: true },
      { name: 'ECOMM Tags (box of 1000)', category: 'Store Supply Order', unitPriceCents: 500, maxQuantity: 2, isActive: true },
      { name: 'ECOMM Zip Ties (bag of 1000)', category: 'Store Supply Order', unitPriceCents: 600, maxQuantity: 2, isActive: true },
      { name: 'Clear 8" Zipties', category: 'Store Supply Order', unitPriceCents: 350, maxQuantity: 1, isActive: true },
      { name: '9 Volt Batteries', category: 'Store Supply Order', unitPriceCents: 500, maxQuantity: 1, isActive: true },
      { name: 'AA Batteries', category: 'Store Supply Order', unitPriceCents: 400, maxQuantity: 1, isActive: true },
      { name: 'AAA Batteries', category: 'Store Supply Order', unitPriceCents: 400, maxQuantity: 1, isActive: true },
      { name: 'C Batteries', category: 'Store Supply Order', unitPriceCents: 500, maxQuantity: 1, isActive: true },
      { name: 'Shirt Hanger Grips', category: 'Store Supply Order', unitPriceCents: 200, maxQuantity: 2, isActive: true },
      { name: 'Window Squeegee', category: 'Store Supply Order', unitPriceCents: 800, maxQuantity: 1, isActive: true },
      { name: 'Sterilization Tags (250)', category: 'Store Supply Order', unitPriceCents: 400, maxQuantity: 4, isActive: true },
      
      // Labels, Tape, & Office Supplies
      { name: 'Sterifab Dispenser', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 2, isActive: true },
      { name: 'Safety Labels (sheet of 15)', category: 'Store Supply Order', unitPriceCents: 300, maxQuantity: 1, isActive: true },
      { name: 'Scotch Tape', category: 'Store Supply Order', unitPriceCents: 400, maxQuantity: 1, isActive: true },
      { name: 'Yellow Tape', category: 'Store Supply Order', unitPriceCents: 500, maxQuantity: 4, isActive: true },
      { name: 'Dry Erase Black', category: 'Store Supply Order', unitPriceCents: 300, maxQuantity: 2, isActive: true },
      { name: 'Dry Erase Green', category: 'Store Supply Order', unitPriceCents: 300, maxQuantity: 2, isActive: true },
      { name: 'Dry Erase Red', category: 'Store Supply Order', unitPriceCents: 300, maxQuantity: 2, isActive: true },
      { name: 'Ballpoint Pens', category: 'Store Supply Order', unitPriceCents: 500, maxQuantity: 12, isActive: true },
      { name: 'Highlighters (pack of 6 colors)', category: 'Store Supply Order', unitPriceCents: 600, maxQuantity: 1, isActive: true },
      { name: 'Silver Markers', category: 'Store Supply Order', unitPriceCents: 800, maxQuantity: 12, isActive: true },
      { name: 'Red Markers', category: 'Store Supply Order', unitPriceCents: 800, maxQuantity: 12, isActive: true },
      { name: 'Black Markers', category: 'Store Supply Order', unitPriceCents: 800, maxQuantity: 12, isActive: true },
      { name: 'Counterfeit Markers', category: 'Store Supply Order', unitPriceCents: 1000, maxQuantity: 12, isActive: true },
      { name: 'Magnum Markers', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 2, isActive: true },
      { name: 'Star Post-Its', category: 'Store Supply Order', unitPriceCents: 400, maxQuantity: 2, isActive: true },
      { name: 'White Out', category: 'Store Supply Order', unitPriceCents: 350, maxQuantity: 1, isActive: true },
      { name: 'Scissors', category: 'Store Supply Order', unitPriceCents: 800, maxQuantity: 1, isActive: true },
      { name: 'Wire Cutters', category: 'Store Supply Order', unitPriceCents: 1000, maxQuantity: 1, isActive: true },
      { name: 'Staplers', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 1, isActive: true },
      { name: 'Staples', category: 'Store Supply Order', unitPriceCents: 400, maxQuantity: 1, isActive: true },
      { name: 'Safety Box Cutter', category: 'Store Supply Order', unitPriceCents: 600, maxQuantity: 6, isActive: true },
      { name: 'Vacuum Belts', category: 'Store Supply Order', unitPriceCents: 800, maxQuantity: 2, isActive: true },
      { name: 'Truck Seals', category: 'Store Supply Order', unitPriceCents: 500, maxQuantity: 45, isActive: true },
      
      // Gloves & PPE
      { name: 'Gloves Heavy Duty – M (one pair)', category: 'Store Supply Order', unitPriceCents: 500, maxQuantity: 1, isActive: true },
      { name: 'Gloves Heavy Duty – L (one pair)', category: 'Store Supply Order', unitPriceCents: 500, maxQuantity: 1, isActive: true },
      { name: 'Gloves Heavy Duty – XL (one pair)', category: 'Store Supply Order', unitPriceCents: 500, maxQuantity: 1, isActive: true },
      { name: 'Nylon Gloves – S (pack of 12)', category: 'Store Supply Order', unitPriceCents: 600, maxQuantity: 1, isActive: true },
      { name: 'Nylon Gloves – M (pack of 12)', category: 'Store Supply Order', unitPriceCents: 600, maxQuantity: 1, isActive: true },
      { name: 'Nylon Gloves – L (pack of 12)', category: 'Store Supply Order', unitPriceCents: 600, maxQuantity: 1, isActive: true },
      { name: 'Nylon Gloves – XL (pack of 12)', category: 'Store Supply Order', unitPriceCents: 600, maxQuantity: 1, isActive: true },
      { name: 'Disposable Masks', category: 'Store Supply Order', unitPriceCents: 300, maxQuantity: 2, isActive: true },
      { name: 'Goggles', category: 'Store Supply Order', unitPriceCents: 800, maxQuantity: 2, isActive: true },
      
      // Stickers & Tags
      { name: 'White Tags (case)', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 3, isActive: true },
      { name: 'White Stickers (case)', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 3, isActive: true },
      { name: 'Red Tags (case)', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 3, isActive: true },
      { name: 'Red Stickers (case)', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 3, isActive: true },
      { name: 'Yellow Tags (case)', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 3, isActive: true },
      { name: 'Yellow Stickers (case)', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 3, isActive: true },
      { name: 'Green Tags (case)', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 3, isActive: true },
      { name: 'Green Stickers (case)', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 3, isActive: true },
      { name: 'Blue Tags (case)', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 3, isActive: true },
      { name: 'Blue Stickers (case)', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 3, isActive: true },
      { name: 'Orange Stickers (roll)', category: 'Store Supply Order', unitPriceCents: 800, maxQuantity: 1, isActive: true },
      
      // Bags & Paper
      { name: 'Reusable Bags – Large Design', category: 'Store Supply Order', unitPriceCents: 200, maxQuantity: 4, isActive: true },
      { name: 'Reusable Bags – Small Blue', category: 'Store Supply Order', unitPriceCents: 150, maxQuantity: 2, isActive: true },
      { name: 'Thermal Paper', category: 'Store Supply Order', unitPriceCents: 400, maxQuantity: 1, isActive: true },
      { name: 'Rubberbands', category: 'Store Supply Order', unitPriceCents: 500, maxQuantity: 4, isActive: true },
      
      // Nitrile Gloves (merged into Gloves & PPE)
      { name: 'Nitrile Gloves – S (case of 1000)', category: 'Store Supply Order', unitPriceCents: 1500, maxQuantity: 1, isActive: true },
      { name: 'Nitrile Gloves – M (case of 1000)', category: 'Store Supply Order', unitPriceCents: 1500, maxQuantity: 1, isActive: true },
      { name: 'Nitrile Gloves – L (case of 1000)', category: 'Store Supply Order', unitPriceCents: 1500, maxQuantity: 1, isActive: true },
      { name: 'Nitrile Gloves – XL (case of 1000)', category: 'Store Supply Order', unitPriceCents: 1500, maxQuantity: 1, isActive: true },
      
      // Hangers
      { name: "Children's Hangers", category: 'Store Supply Order', unitPriceCents: 200, maxQuantity: 6, isActive: true },
      { name: 'Shirt Hangers', category: 'Store Supply Order', unitPriceCents: 250, maxQuantity: 10, isActive: true },
      { name: 'Pant Hangers', category: 'Store Supply Order', unitPriceCents: 300, maxQuantity: 10, isActive: true },
      
      // Store Apparel
      { name: 'Aprons', category: 'Store Supply Order', unitPriceCents: 800, maxQuantity: 10, isActive: true },
      { name: 'Baseball Caps', category: 'Store Supply Order', unitPriceCents: 600, maxQuantity: 10, isActive: true },
      { name: 'Beanies', category: 'Store Supply Order', unitPriceCents: 500, maxQuantity: 10, isActive: true },
      
      // Miscellaneous
      { name: 'Sterifab', category: 'Store Supply Order', unitPriceCents: 1200, maxQuantity: 6, isActive: true },
      { name: 'Sortkwik Fingertip Moistener', category: 'Store Supply Order', unitPriceCents: 400, maxQuantity: 2, isActive: true },
      { name: 'Sizing and Colorization Charts', category: 'Store Supply Order', unitPriceCents: 300, maxQuantity: 10, isActive: true },
    ],
  })
  ...
  await prisma.product.createMany({
    data: [
      // General Supplies
      { name: 'Rubberbands (ADC S)', category: 'ADC Supply Order', unitPriceCents: 500, maxQuantity: 4, isActive: true },
      { name: 'Magnum Markers (ADC S)', category: 'ADC Supply Order', unitPriceCents: 1200, maxQuantity: 2, isActive: true },
      { name: 'Gloves Heavy Duty – M (one pair) (ADC S)', category: 'ADC Supply Order', unitPriceCents: 500, maxQuantity: 1, isActive: true },
      { name: 'Gloves Heavy Duty – L (one pair) (ADC S)', category: 'ADC Supply Order', unitPriceCents: 500, maxQuantity: 1, isActive: true },
      { name: 'Gloves Heavy Duty – XL (one pair) (ADC S)', category: 'ADC Supply Order', unitPriceCents: 500, maxQuantity: 1, isActive: true },
      { name: 'Nitrile Gloves – S (box of 100) (ADC S)', category: 'ADC Supply Order', unitPriceCents: 1500, maxQuantity: 2, isActive: true },
      { name: 'Nitrile Gloves – M (box of 100) (ADC S)', category: 'ADC Supply Order', unitPriceCents: 1500, maxQuantity: 2, isActive: true },
      { name: 'Nitrile Gloves – L (box of 100) (ADC S)', category: 'ADC Supply Order', unitPriceCents: 1500, maxQuantity: 2, isActive: true },
      { name: 'Nitrile Gloves – XL (box of 100) (ADC S)', category: 'ADC Supply Order', unitPriceCents: 1500, maxQuantity: 2, isActive: true },
      { name: 'Nylon Gloves – S (pack of 12) (ADC S)', category: 'ADC Supply Order', unitPriceCents: 600, maxQuantity: 1, isActive: true },
      { name: 'Nylon Gloves – M (pack of 12) (ADC S)', category: 'ADC Supply Order', unitPriceCents: 600, maxQuantity: 1, isActive: true },
      { name: 'Nylon Gloves – L (pack of 12) (ADC S)', category: 'ADC Supply Order', unitPriceCents: 600, maxQuantity: 1, isActive: true },
      { name: 'Nylon Gloves – XL (pack of 12) (ADC S)', category: 'ADC Supply Order', unitPriceCents: 600, maxQuantity: 1, isActive: true },
      { name: 'Disposable Masks (ADC S)', category: 'ADC Supply Order', unitPriceCents: 300, maxQuantity: 1, isActive: true },
      { name: 'Case of Water (ADC S)', category: 'ADC Supply Order', unitPriceCents: 500, maxQuantity: 5, isActive: true },
      // Store Apparel
      { name: 'Aprons (ADC S)', category: 'ADC Supply Order', unitPriceCents: 800, maxQuantity: 5, isActive: true },
      { name: 'Baseball Caps (ADC S)', category: 'ADC Supply Order', unitPriceCents: 600, maxQuantity: 5, isActive: true },
      { name: 'Beanies (ADC S)', category: 'ADC Supply Order', unitPriceCents: 500, maxQuantity: 5, isActive: true },
    ],
  })
  ...
  await prisma.product.createMany({
    data: [
      { name: 'Toilet Paper (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 2000, maxQuantity: 1, isActive: true },
      { name: 'Toilet Paper Dispensers (single) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 1500, maxQuantity: 1, isActive: true },
      { name: 'Toilet Brush (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 800, maxQuantity: 1, isActive: true },
      { name: 'Urinal Block with Screen (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 2500, maxQuantity: 1, isActive: true },
      { name: 'Paper Towels (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 3000, maxQuantity: 1, isActive: true },
      { name: 'Paper Towel Dispensers (single) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 1800, maxQuantity: 1, isActive: true },
      { name: 'Antibacterial Hand Foam Soap (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 3500, maxQuantity: 1, isActive: true },
      { name: 'Soap Dispensers (single) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 1200, maxQuantity: 1, isActive: true },
      { name: 'Disinfectant Foam Cleaner (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 4000, maxQuantity: 1, isActive: true },
      { name: 'Lysol Disinfectant Spray (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 4500, maxQuantity: 1, isActive: true },
      { name: 'Clear Trash Bags – Large (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 2500, maxQuantity: 1, isActive: true },
      { name: 'Clear Trash Bags – Small (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 2000, maxQuantity: 1, isActive: true },
      { name: 'Bleach (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 1500, maxQuantity: 1, isActive: true },
      { name: 'Quat 64 Concentrate Disinfectant (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 5000, maxQuantity: 1, isActive: true },
      { name: 'Masking Tape (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 1200, maxQuantity: 1, isActive: true },
      { name: 'Sanitary Napkin Bags (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 1800, maxQuantity: 1, isActive: true },
      { name: 'OneShot Floor Cleaner (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 3500, maxQuantity: 1, isActive: true },
      { name: 'Backbraces (each) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 2500, maxQuantity: 2, isActive: true },
      { name: 'Dustpan & Brush (normal length broom) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 1500, maxQuantity: 1, isActive: true },
      { name: 'Hand Sanitizer Foaming Ref. (case) (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 4000, maxQuantity: 1, isActive: true },
      { name: 'Hand Sanitizer – single pump bottle (ADC M)', category: 'ADC Maintenance Order', unitPriceCents: 800, maxQuantity: 1, isActive: true },
    ],
  })
